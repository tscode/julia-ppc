...
extern "C" void v0(float* r, const float* d, int n) {
  for (int i = 0; i < n; ++i) {
    for (int j = 0; j < n; ++j) {
      float v = infty;
      for (int k = 0; k < n; ++k) {
...
extern "C" void v1(float* r, const float* d, int n) {
...
extern "C" void v2(float* r, const float* d_, int n) {
    constexpr int nb = 4;
    int na = (n + nb - 1) / nb;
    int nab = na*nb;
...
extern "C" void v3(float* r, const float* d_, int n) {
    // elements per vector
    constexpr int nb = 8;
...
extern "C" void v4(float* r, const float* d_, int n) {
    // elements per vector
    constexpr int nb = 8;
    // vectors per input row
    int na = (n + nb - 1) / nb;
